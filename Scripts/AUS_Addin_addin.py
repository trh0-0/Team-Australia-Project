...
class ClearSelection_1(object):
    """Implementation for AUS_Addin_addin.tool_2 (Tool)"""
    def __init__(self):
        self.enabled = True
	...
	def onClick(self):
        ...
        pass
class ZoomToSelection_1(object):
    """Implementation for AUS_Addin_addin.tool_1 (Tool)"""
    def __init__(self):
        self.enabled = True
        self.shape = "NONE" # Can set to "Line", "Circle" or "Rectangle" for interactive shape drawing and to activate the onLine/Polygon/Circle event sinks.
    def onMouseDown(self, x, y, button, shift):
...
class Zoomtofullextent(object):
    """Implementation for AUS_Addin_addin.tool (Tool)"""
    def __init__(self):
        self.enabled = True
        self.shape = "NONE" # Can set to "Line", "Circle" or "Rectangle" for interactive shape drawing and to activate the onLine/Polygon/Circle event sinks.
    def onMouseDown(self, x, y, button, shift):
